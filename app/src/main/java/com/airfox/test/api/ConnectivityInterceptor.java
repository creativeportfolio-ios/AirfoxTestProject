...
/**
 * Created by habib.durodola on 2017-10-31.
 */
public class ConnectivityInterceptor implements Interceptor {
    ...
    public boolean isOnline() {
        if (App.getApp().getContext() != null) {
            ConnectivityManager cm = (ConnectivityManager) App.getApp().getContext().getSystemService("connectivity");
            return isConnectedFast(App.getApp().getContext(), cm);
        }
        return false;
    }
